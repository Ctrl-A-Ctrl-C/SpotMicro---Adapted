...
class MotionController:
        ...
        while continuer == True:
            ...
            if self._motion_queue.empty():
                ...
                if (lying == True) and (arise == False) and (down == False):
                    ...
                    pos = Spot.moving (t, start_frame_pos,end_frame_pos, pos)
                    t=t+1*tstep #speed, this is good.
                    if (t >= 1):
                        t = 0
                        arise = True
                    print(t)
    ...
    def moving_feet(self, thetalf, thetarf, thetarr, thetalr, t, timing):
        ...
        # front left angle
        delta_front_shoulder_left = 180 - (int(thetalf[0] * (180/pi))*0.8 + 90) 
        ...
        delta_front_feet_left = (int(thetalf[2] * (180/pi)) + 150) 
        #print("Feet_front_left:", delta_front_feet_left)
        
        # front right angle
        delta_front_shoulder_right = 180 - (int(thetarf[0] * (180/pi))*0.8 + 90) 
        ...
        delta_front_feet_right = 180 - (int(thetarf[2] * (180/pi)) + 150) 
        #print("Feet_front_right:", delta_front_feet_right)
        
        # rear left angle
        delta_rear_shoulder_left = int(thetalr[0] * (180/pi))*0.8 + 90
        ...
        delta_rear_feet_left = int(thetalr[2] * (180/pi)) + 155
        #print("Feet_rear_left:", delta_rear_feet_left)
        
        # rear right angle
        delta_rear_shoulder_right = int(thetarr[0] * (180/pi))*0.8 + 90
        ...
        delta_rear_feet_right = 180 - (int(thetarr[2] * (180/pi)) + 155) 
