...
class MotionController:
    ...
    def auto_walking(self):
        ...
        while continuer == True:
            if self._motion_queue.empty():
                ...
                # TEMP
                bz_step.StepLength = 0.02
                bz_step.LateralFraction = 0.0
                bz_step.YawRate = 0.0
                bz_step.StepVelocity = 0.5
                contacts = state[-4:]
                # Get Desired Foot Poses
                T_bf = bzg.GenerateTrajectory(0.02, 0.0, 0.0,
                                              1, T_bf0, T_bf,
                                              0.001, 0.03,
                                              contacts)
                ...
                thetalf = joint_angles[0]
                thetarf = joint_angles[1]
                thetarr = joint_angles[3]
                thetalr = joint_angles[2]
                
                #print(thetalf)
                
                self.moving_feet2(thetalf, thetarf, thetarr, thetalr, t, timing)
    ...
    def moving_feet2(self, thetalf, thetarf, thetarr, thetalr, t, timing):
        
        # front left angle
        delta_front_shoulder_left = 180 - (int(thetalf[0] * (180/pi)) + 90)
        #print("Shoulder_front_left:", delta_front_shoulder_left)
        
        delta_front_leg_left = 180 - (int(thetalf[1] * (180/pi)) + 30)
        #print("Leg_front_left:", delta_front_leg_left)
        
        delta_front_feet_left = int((thetalf[2] * (180/pi)) * -1) - 30
        #print("Feet_front_left:", delta_front_feet_left)
        ...
        delta_front_leg_right = int(thetarf[1] * (180/pi)) + 30
        #print("Leg_front_right:", delta_front_leg_right)
        
        delta_front_feet_right = 180 - (int((thetarf[2] * (180/pi)) * -1) - 30)
        #print("Feet_front_right:", delta_front_feet_right)
        ...
        delta_rear_leg_left = 180 - (int(thetalr[1] * (180/pi)) + 30) 
        #print("Leg_rear_left:", delta_rear_leg_left)
        
        delta_rear_feet_left = int((thetalr[2] * (180/pi)) * -1) - 30
        #print("Feet_rear_left:", delta_rear_feet_left)
        ...
        delta_rear_leg_right = int(thetarr[1] * (180/pi)) + 30
        #print("Leg_rear_right:", delta_rear_leg_right)
        
        delta_rear_feet_right = 180 - (int((thetarr[2] * (180/pi)) * -1) - 30)
        #print("Feet_rear_right:", delta_rear_feet_right)
