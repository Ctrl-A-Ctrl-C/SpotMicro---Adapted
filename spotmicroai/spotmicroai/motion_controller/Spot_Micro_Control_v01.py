...
while (continuer):
        ...
        ************************************************************************************************
        ...
        thetalf, thetarf, thetarr, thetalr are the sets of angles that can be sent to the servos 
        ...
        ************************************************************************************************ 
        ...
        #delta_front_feet_right = 180 - abs(int(thetalf[1] * (180/pi))) 
        #LF_1 = int(thetalf[2] * (180/pi) + 90)
        #LF_1 = thetalf[2]
        print(joypos[pos_leftpaw])
        sleep(0.02)
