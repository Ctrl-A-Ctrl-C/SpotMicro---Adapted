...
from spotmicroai.motion_controller.motion_controller_2 import MotionController
...
def main():
    ...
    # Moves the servos
    motion_controller_2 = multiprocessing.Process(target=process_motion_controller, args=(communication_queues,))
    motion_controller_2.daemon = True
    ...
    if not motion_controller_2.is_alive():
